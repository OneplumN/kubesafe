...
import { SimulationScenariosPage } from '../pages/SimulationScenariosPage';
import { SimulationYamlLabPage } from '../pages/SimulationYamlLabPage';
...
function ProtectedRoutes() {
  ...
  return (
    <AppLayout>
      <Routes>
        <Route path="/simulation/yaml-lab" element={<SimulationYamlLabPage />} />
        <Route path="/simulation/scenarios" element={<SimulationScenariosPage />} />
        ...
        <Route path="*" element={<Navigate to="/simulation/yaml-lab" replace />} />
      </Routes>
    </AppLayout>
  );
}
